  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
        ...
        <div className="pt-3 mt-3 border-t border-navy-800/80">
          <div className="px-2.5 py-1.5 text-[10px] font-bold text-slate-400 uppercase tracking-wider">
            Portal Control
          </div>
          ...
          <Link
            ...
            className="flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-medium text-slate-300 hover:bg-navy-900 hover:text-white transition-all group tap-bounce"
          >
